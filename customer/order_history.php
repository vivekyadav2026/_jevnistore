            ...
            <div class="order-accordion">
                ...
                if ($result->num_rows > 0) {
                    while ($o = $result->fetch_assoc()) {
                        ...
                        <div class="order-card" id="order-card-<?php echo $order_id; ?>">
                            ...
                            <div class="order-details" id="order-details-<?php echo $order_id; ?>">
                                ...
                                <?php else: ?>
                                <div style="background: rgba(220, 38, 38, 0.1); border: 1px solid rgba(220, 38, 38, 0.3); border-radius: 8px; padding: 12px; margin-bottom: 20px; color: #ef4444; font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; display: flex; align-items: center; gap: 8px;">
                                        ...
                                        <div class="order-items-list">
                                            ...
                                            <div class="order-item-row">
                                                ...
                                                <div class="order-item-info">
                                                    <a href="<?php echo BASE_URL; ?>/product.php?id=<?php echo $item['product_id']; ?>" class="order-item-name"><?php echo htmlspecialchars($item['name']); ?></a>
                    ...
                    <div style="text-align: center; padding: 40px 0; border: 1px dashed var(--border-color); border-radius: 8px;">
                        ...
                        <a href="<?php echo BASE_URL; ?>/shop.php" class="btn btn-sm">Start Shopping</a>
                    </div>
                    <?php
                }
                ?>
