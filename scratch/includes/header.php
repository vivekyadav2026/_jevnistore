...
<head>
    ...
    <title>Jevani Store | Modern Edgy Clothing</title>
    <meta name="description" content="Shop the latest streetwear. Baggy pants, hoodies, and cyberpunk fashion.">
...
<body>
    ...
    <header class="header" id="main-header">
        <div class="container header-inner">
            ...
            <div class="logo-wrapper">
                <a href="/index.php" class="logo">
                    <img src="/assets/logo.png" alt="Jevani Store">
                </a>
            </div>
            ...
            <div class="header-icons">
                ...
                <?php if(isLoggedIn()): ?>
                    <a href="<?php echo isAdmin() ? '/admin/index.php' : '/customer/index.php'; ?>" class="icon-btn header-user-icon hide-mobile" aria-label="Account" title="Dashboard">
                        <i data-lucide="user"></i>
                    </a>
                <?php else: ?>
                    <a href="/login.php" class="icon-btn header-user-icon hide-mobile" aria-label="Account" title="Login">
                        <i data-lucide="user"></i>
                    </a>
                <?php endif; ?>
                <a href="/wishlist.php" class="icon-btn header-wishlist-icon hide-mobile" aria-label="Wishlist"><i data-lucide="heart"></i></a>
        ...
        <div class="header-search-bar" id="header-search-bar">
            <div class="container">
                <form action="/shop.php" method="GET" class="search-form-wrapper">
