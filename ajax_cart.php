...
if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
        ...
        <div class="cart-item">
            ...
            <div class="cart-item-info">
                <div>
                    ...
                    <p style="font-size: 0.8rem; color: var(--text-secondary);">QTY: '.$item['quantity'].'</p>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                    ...
                    <form action="'.BASE_URL.'/cart_action.php" method="POST" class="ajax-remove-form" style="display:inline;">
                        ...
                        <button type="submit" style="background:none;border:none;color:var(--text-secondary);cursor:pointer;font-size:0.7rem;text-transform:uppercase;letter-spacing:1px;text-decoration:underline;">Remove</button>
                    </form>
                </div>
            </div>
        </div>';
    ...
    $html .= '<p style="text-align: center; color: var(--text-secondary); margin-top: 50px; letter-spacing: 1px;">YOUR CART IS EMPTY</p>';
}
...
$html .= '</div>';
$html .= '<p style="text-align: center; font-size: 0.75rem; color: var(--text-secondary); margin-bottom: 15px;">Or continue shopping</p>';
$html .= '<div style="display: flex; justify-content: center; gap: 15px; margin-bottom: 20px; font-size: 0.7rem; font-weight: 500; letter-spacing: 1px; color: var(--text-secondary);">';
$html .= '<span>VISA</span>';
